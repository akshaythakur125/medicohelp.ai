...
TOPICS = [
    ...
    # ── Concise Notes ─────────────────────────────────────────────────────────
    {
        ...
        "caption": (
            ...
            "Most abundant protein in the body; structural scaffold of connective tissue, bone, and tendons\n\n"
            "Steps of Synthesis:\n"
            "1. TRANSLATION (RER): Pro-alpha chains synthesised; key sequence = Gly-X-Y repeats\n"
            "   (X = Proline; Y = Hydroxyproline or Hydroxylysine)\n"
            "2. HYDROXYLATION (RER): Pro → Hydroxyproline; Lys → Hydroxylysine\n"
            "   Enzymes: Prolyl hydroxylase & Lysyl hydroxylase\n"
            "   Cofactor: Vitamin C (ascorbic acid) — ESSENTIAL\n"
            "   Deficiency → scurvy (unstable collagen, perifollicular haemorrhage, bleeding gums)\n"
            "3. GLYCOSYLATION (RER): Galactose/glucose added to hydroxylysine residues\n"
            "4. TRIPLE HELIX FORMATION (RER): 3 pro-alpha chains → procollagen\n"
            "5. SECRETION via Golgi vesicles → extracellular space\n"
            "6. CLEAVAGE (extracellular): N- & C-propeptides cleaved by procollagen peptidase\n"
            "   → tropocollagen; defect causes Dermatosparaxis-type Ehlers-Danlos\n"
            "7. CROSS-LINKING (extracellular): Lysyl oxidase (Cu²⁺-dependent) oxidises Lys residues\n"
            "   → allysine → covalent cross-links → mature collagen fibrils\n"
            ...
            "• Type III — Fetal tissue, blood vessels, healing wounds (first to appear)\n"
            ...
            "• Ehlers-Danlos Syndrome: Defective collagen structure/cross-linking → hyperextensible joints\n"
    ...
    # ── PYQ Concept ───────────────────────────────────────────────────────────
    {
        ...
        "caption": (
            ...
            "NEET-PG tests this topic in graph interpretation and drug-mechanism questions every year.\n\n"
            "Core Parameters:\n"
            "• Km (Michaelis constant): [S] at which V = ½ Vmax; reflects enzyme-substrate affinity\n"
            "  — Low Km = High affinity | High Km = Low affinity\n"
            "• Vmax: Maximum reaction velocity; proportional to total enzyme concentration\n"
            "• Kcat: Turnover number — reactions catalysed per enzyme molecule per second\n\n"
            "Inhibition Types — Most Tested Table:\n"
            "─────────────────────────────────────────────────────────\n"
            "Type               Km            Vmax        Reversible?\n"
            "─────────────────────────────────────────────────────────\n"
            "Competitive        ↑ (apparent)  Unchanged   Yes (excess substrate)\n"
            "Non-competitive    Unchanged     ↓ decreased No\n"
            "Uncompetitive      ↓ decreased   ↓ decreased No\n"
            "Mixed              ↑ or ↓        ↓ decreased No\n"
            "─────────────────────────────────────────────────────────\n\n"
            "Lineweaver-Burk Plot (1/V vs 1/[S]):\n"
            "• Competitive: Lines intersect on Y-axis (same Vmax intercept; different Km)\n"
            "• Non-competitive: Lines intersect on X-axis (same Km intercept; different Vmax)\n"
            "• Uncompetitive: Parallel lines (both intercepts change equally)\n\n"
            "Classic NEET-PG Drug Examples:\n"
            "• Methotrexate: Competitive inhibitor of DHFR → ↑ Km, same Vmax\n"
            "• Allopurinol: Competitive inhibitor of xanthine oxidase (converted to oxypurinol → irreversible)\n"
            "• Aspirin: Irreversible acetylation of COX-1/2 serine (suicide inhibitor)\n"
            "• Penicillin: Irreversible inhibitor of transpeptidase (PBP)\n\n"
            "Zero-order vs First-order Kinetics:\n"
            "• Zero-order: Rate constant regardless of [S] — enzyme saturated (Alcohol, Phenytoin, high-dose Aspirin)\n"
