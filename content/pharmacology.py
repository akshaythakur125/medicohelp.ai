...
TOPICS = [
    ...
    },
    {
        ...
        "caption": (
            ...
            "CLINICAL USES:\n"
            "• Gentamicin: Gram-negative sepsis, infective endocarditis (synergy)\n"
            "• Amikacin: MDR TB, hospital-acquired infections\n"
            "• Neomycin: Bowel prep, hepatic encephalopathy (oral, non-absorbable)\n"
            "• Streptomycin: TB second-line agent\n\n"
            "⚠️ Exam Trap: Gentamicin therapeutic range: Peak 5–10 μg/mL; Trough <2 μg/mL (prevents toxicity)."
        ),
    ...
    # ── Concise Notes ─────────────────────────────────────────────────────────
    {
        ...
        "caption": (
            ...
            "Renin → Angiotensin I → [ACE] → Angiotensin II → AT1 receptor\n"
            "AT1 receptor effects: Vasoconstriction, aldosterone release, Na retention, thirst\n\n"
            "ACE INHIBITORS:\n"
            "Drugs: Ramipril, Enalapril, Lisinopril, Captopril (prototype), Perindopril\n"
            "Mechanism: Block ACE → ↓ Ang II + ↑ Bradykinin (ACE also degrades bradykinin)\n\n"
            "ARBs (Angiotensin Receptor Blockers):\n"
            "Drugs: Losartan, Valsartan, Irbesartan, Candesartan, Telmisartan\n"
            "Mechanism: Block AT1 receptor directly → ↓ Ang II effects; bradykinin NOT affected\n\n"
            "COMPARISON:\n"
            "Feature              ACE Inhibitors            ARBs\n"
            "────────────────────────────────────────────────────────────\n"
            "Dry cough            YES (bradykinin ↑)        NO (use if ACEi cough)\n"
            "Angioedema           YES (rare; bradykinin)    Less common\n"
            "Renal protection     YES (↓ GFR, ↓ proteinuria) YES (similar)\n"
            "Aldosterone effect   ↓ (less than spironolactone) ↓\n"
            "Teratogenicity       YES (Category D, all trimesters) YES\n"
            "────────────────────────────────────────────────────────────\n\n"
            "INDICATIONS (Both ACEi and ARBs):\n"
            ...
            "• Pregnancy (Category D — all three trimesters; renal agenesis, oligohydramnios)\n"
            "• Bilateral renal artery stenosis (↓ GFR precipitously — Ang II maintains GFR via efferent arteriole constriction)\n"
            "• Hyperkalaemia, Angioedema (for ACEi)\n\n"
            "⚠️ Exam Trap: ACEi + ARB combination (dual RAAS blockade) is NOT recommended — ↑ risk of AKI and hyperkalaemia.\n"
            "Captopril is the only ACEi with sulfhydryl group — associated with rash and taste disturbance."
        ),
    ...
    # ── PYQ Concept ───────────────────────────────────────────────────────────
    {
        ...
        "caption": (
            ...
            "NEET-PG tests receptor pharmacology through drug classification and dose-response curves.\n\n"
            ...
            "Partial agonist   +          Intermediate (<1.0) Submaximal response\n"
            "Antagonist        +          Zero (0)    No response; blocks agonist\n"
            "Inverse agonist   +          Negative    Reduces constitutive activity\n"
            "──────────────────────────────────────────────────────────────────\n\n"
            "Partial Agonist Key Concept:\n"
            "• Acts as an agonist alone (weak effect)\n"
            "• Acts as a FUNCTIONAL ANTAGONIST in presence of a full agonist (competes, but gives less response)\n"
            "• Examples: Buprenorphine (opioid), Pindolol (β-blocker with ISA), Buspirone (5-HT1A)\n\n"
            "Competitive vs Non-competitive Antagonism:\n"
            "Feature              Competitive              Non-competitive\n"
            "────────────────────────────────────────────────────────────\n"
            "Mechanism            Reversible; competes     Irreversible or allosteric\n"
            "Vmax                 Unchanged (overcome)     ↓ (cannot overcome)\n"
            "EC50 (apparent Km)   ↑ Rightward shift        Rightward + depressed max\n"
            "Example              Naloxone (opioid)        Phenoxybenzamine (α-blocker)\n"
            "────────────────────────────────────────────────────────────\n\n"
            "Receptor Types (NEET-PG Frequently Tested):\n"
            "• Ionotropic (ligand-gated ion channels): GABA-A, NMDA, nAChR — fastest (ms)\n"
            "• G-protein coupled (metabotropic): β-adrenergic, muscarinic — seconds\n"
            "• Tyrosine kinase receptors: Insulin, GH, EGF — hours\n"
            "• Nuclear receptors (intracellular): Steroids, thyroid hormone — hours to days\n\n"
            "Therapeutic Index (TI) = LD50 / ED50\n"
            "• Wide TI (safe): Penicillin, β-blockers\n"
            "• Narrow TI (require monitoring): Digoxin, Phenytoin, Lithium, Warfarin, Aminoglycosides"
        ),
